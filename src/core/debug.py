...
MASTER CONTROL: Set DEBUG_ENABLED = False to disable ALL debug output
"""
import os
import sys
...
# ============================================
# MASTER DEBUG SWITCH - SET TO False FOR CLEAN TERMINAL AND TRUE TO DISPLAY DEBUG OUTPUT
# ============================================
DEBUG_ENABLED = False
# ============================================
